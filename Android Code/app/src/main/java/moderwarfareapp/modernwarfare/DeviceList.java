            ...
            if (!ConnectSuccess) {
                ...
                builder.setTitle("Connected").setMessage("Press \"Ok\" to go back").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(DeviceList.this, UserAreaActivity.class);
                        intent.putExtra("name", name);
                        intent.putExtra("username", username);
                        DeviceList.this.startActivity(intent);
                    }
                }).create().show();
                //a message of "successful connection" is shown and used is redirected in the UserAreaActivity
            }
            progress.dismiss();
        }
    }
