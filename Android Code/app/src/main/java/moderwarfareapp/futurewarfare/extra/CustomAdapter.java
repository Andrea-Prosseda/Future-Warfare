...
public class CustomAdapter extends ArrayAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null) {
            ...
            itemHolder.currentplayers = (TextView) row.findViewById(R.id.currentplayers);
        ...
        itemHolder.currentplayers.setText(items.getPlayersInGame());
        itemHolder.kindOfGame.setText(items.getKindOfGame());
        return row;
    }

    static class ItemHolder{
        TextView game, kindOfGame, creator, location, date, players, start, duration, currentplayers;
    }
}
