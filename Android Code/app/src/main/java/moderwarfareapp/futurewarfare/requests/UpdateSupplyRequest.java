...
public class UpdateSupplyRequest extends StringRequest {
    private static final String REQUEST_URL = "http://modernwarfareapp.altervista.org/backend/operazioni/updateSupply.php";
    private Map<String, String> params;

    public UpdateSupplyRequest (String nameGame, double latitude, double longitude, Response.Listener<String> listener){
